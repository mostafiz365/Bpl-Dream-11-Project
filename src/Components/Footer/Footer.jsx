...
const Footer = () => {
    return (
        <div className='mt-72 md:mt-96 bg-[#06091A] max-w-full relative'>
            <div className='max-w-11/12 mx-auto'>

                <div className='border-2 border-[#FFFFFF] p-6 rounded-3xl bg-[#FFFFFF15] w-11/12 absolute -top-60 md:-top-52'>
                    <div className='background-img rounded-3xl border border-[#13131310]'>
                    <div className='text-center py-10 md:py-20 space-y-5'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 text-center md:text-left gap-20 pt-16 pb-8 md:pb-20'>
